  ...
  return (
    <div className="ops-footer-logo">
      <a
        ...
        className="ops-footer-logo-link"
        aria-label="Opsette home"
      >
        {resolvedSrc ? (
          <img src={resolvedSrc} alt="Opsette" className="ops-footer-logo-img" />
        ) : (
          <span className="ops-footer-logo-text">Opsette</span>
        )}
      </a>
      <div className="ops-footer-logo-links">
        ...
        <a href="https://tools.opsette.io" target="_blank" rel="noopener noreferrer">
          More free tools
        </a>
      </div>
    </div>
